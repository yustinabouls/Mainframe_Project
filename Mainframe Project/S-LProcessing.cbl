       ...
       program-id. S-LProcessing.
       author. Neema, Diego, Yustina, Kinen.
       date-written. 2023-04-07.
      *Program Description: The S&L PROCESSING program is responsible
      * for producing a detail report of all sales with some summary
      * statistics at the end.
       ...
       file-control.
           ...
           select input-file
               assign to "../../../data/salesprocessing.dat"
               organization is line sequential.

           select output-file
               assign to "../../../data/SLReport.out"
               organization is line sequential.
      *
       data division.
       file section.
      ...
      *Variables for calculations
       01 ws-details.
         ...
         05 ws-total-s-records pic 999 value 0.
         05 ws-total-l-records pic 999 value 0.
         ...
         05 ws-01-sl-total pic 9(8) value 0.
         05 ws-02-sl-total pic 9(8) value 0.
         05 ws-03-sl-total pic 9(8) value 0.
         05 ws-04-sl-total pic 9(8) value 0.
         05 ws-05-sl-total pic 9(8) value 0.
         05 ws-12-sl-total pic 9(8) value 0.

      *Headers
       01 ws-header1.
         05 filler pic x(52) value spaces.
         05 filler pic x(21) value "S&L PROCESSING REPORT".
      ...
      *Footers
       ...
       01 ws-footer2.
         05 filler pic x(21) value "Number of S Records: ".
         05 ws-ol-total-s-records pic z9 value zeroes.
         05 filler pic x(102) value spaces.

       01 ws-footer3.
         05 filler pic x(21) value "Number of L Records: ".
         05 ws-ol-total-l-records pic z9 value zeroes.
         05 filler pic x(102) value spaces.
       ...
       01 ws-footer8.
         05 filler pic x(24) value "Store with highest S&L: ".
         05 ws-high-store-sl pic xx.
         05 filler pic x(99) value spaces.

       01 ws-footer9.
         05 filler pic x(23) value "Store with lowest S&L: ".
         05 ws-low-store-sl pic xx.
         05 filler pic x(100) value spaces.
      ...
      *Logic to determine number of S records
           if (in-transaction-code = "S") then
               add 1 to ws-total-s-records
           end-if.

      *Logic to determine number of L records
           if (in-transaction-code = "L") then
      ...
      *Store with high and low S&L
           if in-store-number = "01" then
               add in-transaction-amount to ws-01-sl-total
           end-if.

           if in-store-number = "02" then
               add in-transaction-amount to ws-02-sl-total
           end-if.

           if in-store-number = "03" then
               add in-transaction-amount to ws-03-sl-total
           end-if.

           if in-store-number = "04" then
               add in-transaction-amount to ws-04-sl-total
           end-if.

           if in-store-number = "05" then
               add in-transaction-amount to ws-05-sl-total
           end-if.

           if in-store-number = "12" then
               add in-transaction-amount to ws-12-sl-total
           end-if.

           move "01" to ws-high-store-sl.
           move "01" to ws-low-store-sl.

           if ws-02-sl-total > ws-01-sl-total then
               move "02" to ws-high-store-sl
           end-if.

           if ws-02-sl-total < ws-01-sl-total then
               move "02" to ws-low-store-sl
           end-if.

           if ws-03-sl-total > ws-02-sl-total and
             ws-03-sl-total > ws-01-sl-total then
               move "03" to ws-high-store-sl
           end-if.

           if ws-03-sl-total < ws-02-sl-total and
             ws-03-sl-total < ws-01-sl-total then
               move "03" to ws-low-store-sl
           end-if.

           if ws-04-sl-total > ws-03-sl-total and
             ws-04-sl-total > ws-02-sl-total and
             ws-04-sl-total > ws-01-sl-total then
               move "04" to ws-high-store-sl
           end-if.

           if ws-04-sl-total < ws-03-sl-total and
             ws-04-sl-total < ws-02-sl-total and
             ws-04-sl-total < ws-01-sl-total then
               move "04" to ws-low-store-sl
           end-if.

           if ws-05-sl-total > ws-04-sl-total and
             ws-05-sl-total > ws-03-sl-total and
             ws-05-sl-total > ws-02-sl-total and
             ws-05-sl-total > ws-01-sl-total then
               move "05" to ws-high-store-sl
           end-if.
           ...
           if ws-05-sl-total < ws-04-sl-total and
             ...
             ws-05-sl-total < ws-02-sl-total and
             ws-05-sl-total < ws-01-sl-total then
               move "05" to ws-low-store-sl
           end-if.

           if ws-12-sl-total > ws-05-sl-total and
             ws-12-sl-total > ws-04-sl-total and
             ws-12-sl-total > ws-03-sl-total and
             ws-12-sl-total > ws-02-sl-total and
             ws-12-sl-total > ws-01-sl-total then
               move "12" to ws-high-store-sl
           end-if.
           ...
           if ws-12-sl-total < ws-05-sl-total and
             ...
             ws-12-sl-total < ws-02-sl-total and
             ws-12-sl-total < ws-01-sl-total then
               move "12" to ws-low-store-sl
           end-if.

      *Add totals to footers
           move ws-total-records to ws-ol-total-records.
           move ws-total-s-records to ws-ol-total-s-records.
           move ws-total-l-records to ws-ol-total-l-records.
      ...
      *Mark the file end point
       ...
       400-write-footers.
           ...
           write output-line from ws-footer2
             after advancing 1 line.

           write output-line from ws-footer3
             after advancing 1 line.
